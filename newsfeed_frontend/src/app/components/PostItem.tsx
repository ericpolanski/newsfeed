          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
            <button
              ...
              style={{
                ...
                gap: '4px',
                padding: '6px 12px',
                backgroundColor: likeStatus.isLiked ? '#4267B2' : '#f0f2f5',
                color: likeStatus.isLiked ? 'white' : '#444',
                border: 'none',
                borderRadius: '4px',
                cursor: 'pointer',
                fontSize: '14px',
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
            <button
              ...
              style={{
                ...
                gap: '4px',
                padding: '6px 12px',
                backgroundColor: showComments ? '#4267B2' : '#f0f2f5',
                color: showComments ? 'white' : '#444',
                border: 'none',
                borderRadius: '4px',
                cursor: 'pointer',
                fontSize: '14px',
